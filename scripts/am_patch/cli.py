...
def parse_args(argv: list[str]) -> CliArgs:
    ...
    p.add_argument(
        "--version",
        action="version",
        version=f"am_patch RUNNER_VERSION={RUNNER_VERSION}",
    )
    ...
    p.add_argument(
        ...
        dest="require_push_success",
        action="store_true",
        default=None,
    )
    p.add_argument(
        "--disable-promotion",
        dest="disable_promotion",
        action="store_true",
        default=None,
    )
    p.add_argument(
        "--allow-live-changed",
        dest="allow_live_changed",
        action="store_true",
        default=None,
    )
    p.add_argument(
